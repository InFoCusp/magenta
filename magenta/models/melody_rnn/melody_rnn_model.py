...
default_configs = {
    ...
    # Config for next note distribution model
    # Model description: One hot encoding of current note + probability for next note given current note
    # https://docs.google.com/document/d/1YSR9yF8NyAtqdMzDOZZmyMnmrUTC1BLP3r4NWC990js/edit#heading=h.7ag21j7gl2x1
    'next_note_dist_rnn': MelodyRnnConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
            id='next_note_dist_rnn',
            description='Melody RNN with next note distribution encoded.'),
    ...
    # Config for next note distribution model with attention wrapper cell
    # Model description: One hot encoding of current note + probability for next note given current note
    # https://docs.google.com/document/d/1YSR9yF8NyAtqdMzDOZZmyMnmrUTC1BLP3r4NWC990js/edit#heading=h.7ag21j7gl2x1
