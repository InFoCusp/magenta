...
default_configs = {
    ...
    'pitch_diff_rnn': MelodyRnnConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
            id='pitch_diff_rnn',
            description='Melody RNN with one-hot encoding of pitch difference.'),
    ...
    'pitch_diff_rnn_basic': MelodyRnnConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
    ...
    'pitch_diff_rnn_start_note': MelodyRnnConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
            id='pitch_diff_rnn_start_note',
            description='Melody RNN with one-hot encoding of pitch difference of just -18 to +18 with difference taken from starting note'),
    ...
    'melody_pitch_diff': MelodyRnnConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
